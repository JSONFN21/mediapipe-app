...
class FaceLandmarkerHelper(
    ...
    // Convert the input Bitmap to MP Image and feed it to FacelandmakerHelper.
    ...
    companion object {
        ...
        // Eye indices for MediaPipe Face Mesh (468 landmarks)
        val LEFT_EYE_LANDMARKS = listOf(33, 246, 161, 160, 159, 158, 157, 173, 133, 155, 154, 153, 145, 144, 163, 7)
        val RIGHT_EYE_LANDMARKS = listOf(362, 398, 384, 385, 386, 387, 388, 466, 263, 249, 390, 373, 374, 380, 381, 382)
    }
